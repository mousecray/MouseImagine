...
public class WalletCoinButton extends RDGuiSelectedButton<WalletCoinButton> {
    private       CoinValue coinValue;
    private final String    cachedName;

    public WalletCoinButton(
            GuiShape elementShape, RDFontSize fontSize, CoinValue coinValue,
            Consumer<RDGuiMouseClickEvent<WalletCoinButton>> onClick
    ) {
        super(
    ...
    @Override
    protected void drawButtonLastLayer(@Nonnull RDGuiTickEvent<WalletCoinButton> event) {
        drawButtonTooltip(event);
    }

    protected void drawButtonTooltip(RDGuiTickEvent<WalletCoinButton> event) {
