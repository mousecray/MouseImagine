...
public class RDVillagerRegistry {
...
//        Field careers = RDReflectionUtils.getField(VillagerRegistry.VillagerProfession.class, "careers");
//        Field trades  = RDReflectionUtils.getField(VillagerRegistry.VillagerCareer.class, "trades");
        ForgeRegistries.VILLAGER_PROFESSIONS.getValuesCollection().forEach(profession -> {
//            List<VillagerRegistry.VillagerCareer> list = RDReflectionUtils.getFieldValue(careers, profession);
//            list.forEach(c -> {
//                List<List<EntityVillager.ITradeList>> recipes = RDReflectionUtils.getFieldValue(trades, c);
//                recipes.clear();
//            });
        });
    }
    ...
    public static void register() {
        ...
        VillagerRegistry.VillagerCareer cartographer = new VillagerRegistry.VillagerCareer(
                RDVillagerRegistry.cartographer, Tags.MOD_ID + ":cartographer"
        );
        ...
        cartographer.addTrade(2,
                ...
                new Sell(
                        ...
                        RDItems.UNEXPLORED_TREASURE_MAP, new CountInfo(1, 1),
                        100
                )
        );
        ...
        cartographer.addTrade(3,
                ...
                new Sell(
                        ...
                        RDItems.UNEXPLORED_STRUCTURE_MAP, new CountInfo(1, 1),
                        67
                )
        );
    ...
    public static class SellBanner extends Sell {
        ...
        public void addMerchantRecipe(@Nonnull IMerchant merchant, @Nonnull MerchantRecipeList recipeList, @Nonnull Random random) {
            if (random.nextInt(100) < chance) {
                ...
                RealDreamNBT.get(stack).getDefaultPipe().saveBase(EnumDyeColor.values()[random.nextInt(16)].getMetadata());
