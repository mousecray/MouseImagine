...
public class EntityNBTPipeline {
    ...
    private EntityNBTPipeline(RealDreamNBT.RealDreamNBTEntity container) { this.container = container; }

    static EntityNBTPipeline get(RealDreamNBT.RealDreamNBTEntity base)   { return new EntityNBTPipeline(base); }
