...
public abstract class RealDreamNBT {
    ...
    public static RealDreamNBTEntity get(Entity entity)      { return new RealDreamNBTEntity(entity); }
    public static RealDreamNBTItemStack get(ItemStack stack) { return new RealDreamNBTItemStack(stack); }
    ...
    public static class RealDreamNBTEntity extends RealDreamNBT {
        private final WeakReference<Entity> entity;
        private RealDreamNBTEntity(Entity entity)          { this.entity = new WeakReference<>(entity); }
    ...
    public static class RealDreamNBTItemStack extends RealDreamNBT {
        private final WeakReference<ItemStack> stack;
        private RealDreamNBTItemStack(ItemStack stack)    { this.stack = new WeakReference<>(stack); }
