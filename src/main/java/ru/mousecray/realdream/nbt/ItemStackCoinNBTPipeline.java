...
public class ItemStackCoinNBTPipeline {
    ...
    private ItemStackCoinNBTPipeline(RealDreamNBT.RealDreamNBTItemStack container) { this.container = container; }
    static ItemStackCoinNBTPipeline get(RealDreamNBT.RealDreamNBTItemStack base)   { return new ItemStackCoinNBTPipeline(base); }
