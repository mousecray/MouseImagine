...
public class ItemStackWalletNBTPipeline {
    ...
    private ItemStackWalletNBTPipeline(RealDreamNBT.RealDreamNBTItemStack container) { this.container = container; }
    static ItemStackWalletNBTPipeline get(RealDreamNBT.RealDreamNBTItemStack base)   { return new ItemStackWalletNBTPipeline(base); }
