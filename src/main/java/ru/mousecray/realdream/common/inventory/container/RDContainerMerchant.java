package ru.mousecray.realdream.common.inventory.container;
...
import ru.mousecray.realdream.common.inventory.RDInventoryMerchant;
import ru.mousecray.realdream.common.inventory.slot.RDSlotMerchantResult;

import javax.annotation.ParametersAreNonnullByDefault;

@MethodsReturnNonnullByDefault
@ParametersAreNonnullByDefault
public class RDContainerMerchant extends Container {
    private final IMerchant           merchant;
    private final RDInventoryMerchant merchantInv;

    private final World world;

    public RDContainerMerchant(InventoryPlayer playerInv, IMerchant merchant, World world) {
        this.merchant = merchant;
        this.world = world;
        merchantInv = new RDInventoryMerchant(playerInv.player, merchant);
        addSlotToContainer(new Slot(merchantInv, 0, 36, 53));
        addSlotToContainer(new RDSlotMerchantResult(playerInv.player, merchant, merchantInv, 2, 120, 53));
    ...
    public RDInventoryMerchant getMerchantInventory() { return merchantInv; }
