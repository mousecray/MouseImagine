package ru.mousecray.realdream.common.inventory.slot;
...
public class RDSlotMerchantResult extends Slot {
    private final RDInventoryMerchant merchantInv;
    private final EntityPlayer        player;
    private       int                 removeCount;
    private final IMerchant           merchant;

    public RDSlotMerchantResult(EntityPlayer player, IMerchant merchant, RDInventoryMerchant merchantInv, int slotIndex, int xPosition, int yPosition) {
