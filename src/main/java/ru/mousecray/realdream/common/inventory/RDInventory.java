package ru.mousecray.realdream.common.inventory;
...
public abstract class RDInventory implements IInventory {
    private NonNullList<ItemStack> inventory;

    private final String specificName, customName;

    public RDInventory(int invSize, String specificName, @Nullable String customName) {
