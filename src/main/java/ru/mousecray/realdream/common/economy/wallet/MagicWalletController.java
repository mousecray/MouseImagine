...
import ru.mousecray.realdream.registry.RDPotions;
...
public class MagicWalletController {
    public static void onPutCoin(World world, EntityLivingBase entity) {
        ...
        if (RDRandomUtils.accurateChance(rand, 0.5f)) {
    ...
    private static void shuffleHotbar(EntityPlayer player, World world) {
        ...
        world.playSound(null, player.getPosition(), RDSounds.WALLET_SHUFFLE_HOTBAR, SoundCategory.PLAYERS, 1.0F, 1.0F);
    ...
    private static void spawnFakeMob(World world, EntityLivingBase entity, Random rand, int radius, int attempt) {
        ...
        switch (mobType) {
            case 0: {
                ...
                RealDreamNBT.get(fakeMob).getDefaultPipe().saveFake();
                world.playSound(null, entity.getPosition(), SoundEvents.BLOCK_PORTAL_TRAVEL, SoundCategory.PLAYERS, 1.0F, 1.0F);
    ...
    private static void addRandomPotionEffect(EntityLivingBase entity, Random rand) {
        ...
        switch (effectType) {
            case 0:
                entity.addPotionEffect(new PotionEffect(MobEffects.SPEED, 400 + RDRandomUtils.normalPercentFrom(rand, 400, 24, 1), 0));
                break;
            case 1:
                entity.addPotionEffect(new PotionEffect(MobEffects.BLINDNESS, 200 + RDRandomUtils.normalPercentFrom(rand, 200, 24, 1), 0));
                break;
            case 2:
                entity.addPotionEffect(new PotionEffect(MobEffects.LEVITATION, 100 + RDRandomUtils.normalPercentFrom(rand, 100, 24, 1), 0));
                break;
            case 3:
                entity.addPotionEffect(new PotionEffect(MobEffects.NAUSEA, 200 + RDRandomUtils.normalPercentFrom(rand, 200, 24, 1), 0));
                break;
            case 4:
                entity.addPotionEffect(new PotionEffect(MobEffects.HUNGER, 200 + RDRandomUtils.normalPercentFrom(rand, 200, 24, 1), 0));
                break;
            case 5:
                entity.addPotionEffect(new PotionEffect(MobEffects.WEAKNESS, 300 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), 0));
                break;
            case 6:
                entity.addPotionEffect(new PotionEffect(MobEffects.MINING_FATIGUE, 300 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), 0));
                break;
            case 7:
                entity.addPotionEffect(new PotionEffect(MobEffects.SLOWNESS, 300 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), 0));
                break;
            case 8:
                entity.addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 400 + RDRandomUtils.normalPercentFrom(rand, 400, 24, 1), 0));
                break;
            case 9:
                entity.addPotionEffect(new PotionEffect(MobEffects.REGENERATION, 200 + RDRandomUtils.normalPercentFrom(rand, 200, 24, 1), 0));
                break;
            case 10:
                entity.addPotionEffect(new PotionEffect(MobEffects.WATER_BREATHING, 400 + RDRandomUtils.normalPercentFrom(rand, 400, 24, 1), 0));
                break;
            case 11:
                entity.addPotionEffect(new PotionEffect(MobEffects.FIRE_RESISTANCE, 400 + RDRandomUtils.normalPercentFrom(rand, 400, 24, 1), 0));
                break;
            case 12:
                entity.addPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST, 300 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), 0));
                break;
            case 13:
                entity.addPotionEffect(new PotionEffect(MobEffects.POISON, 200 + RDRandomUtils.normalPercentFrom(rand, 200, 24, 1), 0));
                break;
            case 14:
                entity.addPotionEffect(new PotionEffect(MobEffects.HASTE, 300 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), 0));
                break;
            case 15:
                entity.addPotionEffect(new PotionEffect(MobEffects.GLOWING, 300 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), 0));
                break;
            case 16:
                entity.addPotionEffect(new PotionEffect(MobEffects.LUCK, 600 + RDRandomUtils.normalPercentFrom(rand, 600, 24, 1), 0));
                break;
            case 17:
                entity.addPotionEffect(new PotionEffect(MobEffects.STRENGTH, 300 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), 0));
                break;
        }
    }
    ...
    private static void applyLegendaryEffect(World world, EntityPlayer player, Random rand) {
        ...
        switch (effectType) {
            case 0:
                amplifier = RDRandomUtils.normalChance(rand, 50) ? RDRandomUtils.normalChance(rand, 50) ? 2 : 1 : 0;
                player.addPotionEffect(new PotionEffect(RDPotions.DOUBLE_CRAFT, 240 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), amplifier));
                break;
            case 1:
                amplifier = RDRandomUtils.normalChance(rand, 50) ? RDRandomUtils.normalChance(rand, 50) ? 2 : 1 : 0;
                player.addPotionEffect(new PotionEffect(RDPotions.DOUBLE_FISHING, 240 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), amplifier));
                break;
            case 2:
                amplifier = RDRandomUtils.normalChance(rand, 50) ? RDRandomUtils.normalChance(rand, 50) ? 2 : 1 : 0;
                player.addPotionEffect(new PotionEffect(RDPotions.DOUBLE_MYTHIC, 240 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), amplifier));
                break;
            case 3:
                amplifier = RDRandomUtils.normalChance(rand, 50) ? RDRandomUtils.normalChance(rand, 50) ? 2 : 1 : 0;
                player.addPotionEffect(new PotionEffect(RDPotions.DOUBLE_FARM_HARVEST, 240 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), amplifier));
                break;
            case 4:
                player.addPotionEffect(new PotionEffect(RDPotions.IMMORTALITY, 240 + RDRandomUtils.normalPercentFrom(rand, 300, 24, 1), 0));
                break;
        }
    }
}