...
public class ItemWallet extends RDDefaultItem implements IWallet {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        player.openGui(RealDream.INSTANCE, GuiIdentifiers.WALLET_OPEN_GUI_ID, world, pos.getX(), pos.getY(), pos.getZ());
    ...
    public CoinValue putCoin(World world, EntityLivingBase entity, ItemStack wallet, ItemStack coin) {
        ...
        ItemStackWalletNBTPipeline walletPipe = RealDreamNBT.get(wallet).getWalletPipe();
        ...
        if (!world.isRemote && entity instanceof EntityPlayer) {
            ...
            if (isFull) RDTriggers.FULL_WALLET.trigger(((EntityPlayerMP) entity), getWalletType());
        }
    ...
    public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        if (Minecraft.getMinecraft().player != null) {
            if (Keyboard.isKeyDown(Minecraft.getMinecraft().gameSettings.keyBindSneak.getKeyCode())) {
                ...
                ItemStackWalletNBTPipeline walletPipe = RealDreamNBT.get(stack).getWalletPipe();
