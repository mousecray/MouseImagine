...
import ru.mousecray.mouseproject.core.common.economy.wallet.DefaultWalletType;
import ru.mousecray.mouseproject.core.common.item.ItemUnexploredMap;
import ru.mousecray.mouseproject.core.common.item.coin.ItemCoin;
import ru.mousecray.mouseproject.core.common.item.wallet.*;
import ru.mousecray.mouseproject.core.registry.constants.ItemNames;
...
public class MPItems {
    ...
    public static void onRegistryItem(RegistryEvent.Register<Item> e) {
        ...
        MouseReflection.prepare(MPItems.class).<Item>getPublicStaticFields().forEach(registry::register);
        MouseProject.LOGGER.info("Registered items");
    }

    @SubscribeEvent @SideOnly(Side.CLIENT)
    public static void onRegistryModel(ModelRegistryEvent e) {
        MouseReflection.prepare(MPItems.class).<Item>getPublicStaticFields().forEach(MPItems::registerModel);
